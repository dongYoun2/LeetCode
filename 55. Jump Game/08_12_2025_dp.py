...
# runtime: 1650 ms (beats 11.97%), memory: 18.6 MB (beats 100.00%)
# 7 min
...
# cf.) here is another DP top-down w/ memoization submission: https://leetcode.com/problems/jump-game/submissions/1567301028/
