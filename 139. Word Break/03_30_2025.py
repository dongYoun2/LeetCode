...
# TC: O(w*l + |s|^3) (w*l for creating the "w_dict" set, |s|^2 for looping over "s" and "true_indices" (b/c in worst-case, "true_indices" list can be of length |s|), and |s| for the slicing operation.)
